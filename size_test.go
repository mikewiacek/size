...
func TestStrings(t *testing.T) {
	cases := []struct {
		...
		{1000, 1 * Kilobyte, "1.000KB", "1000B"},
		{1024, 1 * Kibibyte, "1.024KB", "1.000KiB"},
		{1000000, 1 * Megabyte, "1.000MB", "976.562KiB"},
		{1048576, 1 * Mebibyte, "1.049MB", "1.000MiB"},
		{1000000000, 1 * Gigabyte, "1.000GB", "953.674MiB"},
		{1073741824, 1 * Gibibyte, "1.074GB", "1.000GiB"},
		{1000000000000, 1 * Terabyte, "1.000TB", "931.323GiB"},
		{1099511627776, 1 * Tebibyte, "1.100TB", "1.000TiB"},
		{1000000000000000, 1 * Petabyte, "1.000PB", "909.495TiB"},
		{1125899906842624, 1 * Pebibyte, "1.126PB", "1.000PiB"},
		{1000000000000000000, 1 * Exabyte, "1.000EB", "888.178PiB"},
		{1152921504606846976, 1 * Exbibyte, "1.153EB", "1.000EiB"},
		// This is the max value representable by Size.
		{math.MaxInt64, 7*Exbibyte + (1*Exbibyte - 1*Byte), "9.223EB", "8.000EiB"},
	}
